...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function QueueRunner({ subject, limit, onExit }) {
      ...
      if (deck === null) return h('div', { className: 'hst_card hst_review' }, h('p', { className: 'hst_hint' }, '正在取今日队列…'))
    ...
    function TodayTab({ overview, onGoLibrary }) {
      ...
      if (running !== null) {
        return h('div', { className: 'hst_body' }, [
          ...
          h(QueueRunner, { key: 'r', subject: running.subject, onExit: () => setRunning(null) }),
        ])
      }
