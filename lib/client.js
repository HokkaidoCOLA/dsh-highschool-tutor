...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function DemoToolView({ callId, block }) {
      ...
      const rawMeta = settled && block.meta !== null && typeof block.meta === 'object' ? block.meta : null
      // 复习翻卡套组走独立组件（不占用演示的侧栏/窗口逻辑）
      if (rawMeta !== null && rawMeta.kind === 'hst-deck') return h(DeckCard, { deck: rawMeta })
      const meta = rawMeta !== null && rawMeta.kind === 'hst-demo' ? rawMeta : null
